...
export class OllamaProvider implements LLMProvider {
  ...
  async chat(messages: ChatMessage[], model: string = this.defaultModel, options: any = {}): Promise<LLMResponse> {
    try {
  ...
  async completion(prompt: string, model: string = this.defaultModel, options: any = {}): Promise<LLMResponse> {
    try {
