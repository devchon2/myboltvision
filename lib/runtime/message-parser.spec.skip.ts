  ...
  describe('no artifacts', () => {
    ...
    describe('valid artifacts without actions', () => {
      ...
      it('should correctly parse chunks and strip out bolt artifacts (1)', () => {
        ...
        parser.parse(
          'message_1',
          'Some text before <boltArtifact title="Some title" id="artifact_1" type="bundled" >foo</boltArtifact> Some more text',
        );
      ...
      it('should correctly parse chunks and strip out bolt artifacts (2)', () => {
        ...
        parser.parse(
          'message_1',
          'Some text before <boltArtifact title="Some title" id="artifact_1">foo</boltArtifact> Some more text',
        );
...
function runTest(input: string | string[], outputOrExpectedResult: string | ExpectedResult) {
  let expected: { output: string; callbacks?: any } | ExpectedResult;

  if (typeof outputOrExpectedResult === 'string') {
    expected = { output: outputOrExpectedResult, callbacks: {} };
  } else {
