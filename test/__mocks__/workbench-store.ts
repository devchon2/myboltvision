...
import { MockFilesStore, mockWebcontainer } from './stores';
import { MockPreviewsStore, MockTerminalStore, MockEditorStore } from './previews-store';

// Mock pour WorkbenchStore
export class MockWorkbenchStore {
  #previewsStore = new MockPreviewsStore();
  #filesStore = new MockFilesStore();
  #editorStore = new MockEditorStore();
  #terminalStore = new MockTerminalStore();
